...
var drawingApp = (function () {
	...
	var canvas,
		...
		redraw = function () {
			...
			var locX,
				...
				drawCrayon = function (x, y, color, selected) {
					...
					if (selected) {
						...
						context.drawImage(crayonImage, 0, 0, 109, mediumImageHeight, x, y, 59, mediumImageHeight);
					}
				},
				...
				drawMarker = function (x, y, color, selected) {
					...
					if (selected) {
						...
						context.drawImage(markerImage, 0, 0, 109, mediumImageHeight, x, y, 59, mediumImageHeight);
					}
				};
			...
			context.drawImage(outlineImage, 0, 0, 0, 0);
		},
		...
		createUserEvents = function () {
			...
			var press = function (e) {
				...
				var sizeHotspotStartX,
					mouseX = (e.changedTouches ? e.changedTouches[0].pageX : e.pageX) - (this.offsetLeft+10),
					mouseY = (e.changedTouches ? e.changedTouches[0].pageY : e.pageY) - (this.offsetTop+10);
			...
			drag = function (e) {
				...
				var mouseX = (e.changedTouches ? e.changedTouches[0].pageX : e.pageX) - (this.offsetLeft+10),
					mouseY = (e.changedTouches ? e.changedTouches[0].pageY : e.pageY) - (this.offsetTop+10);
